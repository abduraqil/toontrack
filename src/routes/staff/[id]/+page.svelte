...
<svelte:head>
    ...
    <meta
        name="description"
        content={staffer.description || 'No description available.'}
    />
</svelte:head>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                ...
                                {#if staffer.birthday !== null}
                                    <span class="flex items-center gap-1">
                                        <b>Birth:</b>
                                        {staffer.birthday.toDateString()}
                                    </span>
                                {/if}
                                {#if staffer.deathday !== null}
                                    <span class="flex items-center gap-1">
                                        <b>Death:</b>
                                        {staffer.deathday.toDateString()}
                                    </span>
                                {/if}
                            </div>
                        </div>
