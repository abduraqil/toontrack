    ...
    <div class="container mx-auto px-4 py-2">
        <div class="flex items-center justify-between h-16">
            ...
            <ul class="grid grid-cols-2 gap-y-0 gap-x-4">
                <li><b>Search:</b></li>
                <li>
                    <a class="hover:text-gray-500" href="/search/cartoons">
                        Cartoons
                    </a>
                </li>
                <li>
                    <a class="hover:text-gray-500" href="/search/staff">
                        Staff
                    </a>
                </li>
                <li>
                    <a class="hover:text-gray-500" href="/search/characters">
                        Characters
                    </a>
                </li>
                <li>
                    <a class="hover:text-gray-500" href="/search/companies">
                        Companies
                    </a>
                </li>
                <li>
                    <a class="hover:text-gray-500" href="/search/users">
                        Users
                    </a>
                </li>
            </ul>
        ...
        <p>
            Presentation of any work on this site is not an endorsement of its
            content
        </p>
    </div>
</nav>
