...
export const jtCompaniesCompanyTagsRelations = relations(
    jtCompaniesCompanyTags,
    ({ one }) => ({
        company: one(companies, {
...
export const jtCartoonsStaffRelations = relations(
    jtCartoonsStaff,
    ({ one }) => ({
        cartoon: one(cartoons, {
...
export const jtCartoonsCartoonTypesRelations = relations(
    jtCartoonsCartoonTypes,
    ({ one }) => ({
        cartoon: one(cartoons, {
...
export const jtLanguagesStaffRelations = relations(
    jtLanguagesStaff,
    ({ one }) => ({
        language: one(languages, {
...
export const jtCartoonsCountriesRelations = relations(
    jtCartoonsCountries,
    ({ one }) => ({
        cartoon: one(cartoons, {
...
export const jtCartoonsLanguagesRelations = relations(
    jtCartoonsLanguages,
    ({ one }) => ({
        cartoon: one(cartoons, {
...
export const jtOccupationsStaffRelations = relations(
    jtOccupationsStaff,
    ({ one }) => ({
...
export const jtCompaniesCountriesRelations = relations(
    jtCompaniesCountries,
    ({ one }) => ({
        company: one(companies, {
